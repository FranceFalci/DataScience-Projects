# Este módulo orquesta el flujo de inferencia completo:
# Recibe datos crudos (texto).
# Transforma a imagen.
# Predice (usando YOLO).
# Explica (usando GradCAM).
# Post-procesa (genera imágenes visuales).
# Devuelve un paquete completo con diagnóstico, evidencia visual y métricas de rendimiento.
